...
if (( "$GIT_STATUS" > 0 )); then
	git pull
	cd ServiceAppointmentPlugin

	dotnet add ServiceAppointmentPlugin.csproj package Microting.eForm
	dotnet add ServiceAppointmentPlugin.csproj package Microting.AppointmentBase
